...
if(darkTheme) {
  ...
  function initTheme() {
    var darkThemeSelected = (localStorage.getItem('themeSwitch') !== null && localStorage.getItem('themeSwitch') === 'dark-theme');
    darkTheme.checked = darkThemeSelected;
    darkThemeSelected ? document.documentElement.classList.add('dark-theme') : document.documentElement.classList.remove('dark-theme');
  }
  ...
  function toggleTheme() {
    if(darkTheme.checked) {
      ...
      localStorage.setItem('themeSwitch', 'dark-theme');
    } else {
      trans();
